...
RSpec.describe ::Api::V1::Therapists::Branch::Reservations::UpdateCase, type: :model do
  let(:instance) { described_class.new(data) }

  let!(:form) { create(:karte_form) }
  ...
  describe "perform" do
    ...
    before do
      allow(::Api::V1::Therapists::Branch::ReservationForm).to receive(:new).and_return(entry_form)
